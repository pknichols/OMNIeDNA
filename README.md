...
> * **A**dapter - the main component to the OMNIeDNA sampler; TORRENT cone for fast-moving aquatic environments OR BULK/RAPID bottle adapter for 5.1L and 1.5L plastic bottles, respectively
> * **B**ase - the bottom piece to the OMNIeDNA sampler; TORRENT (torpedo-shaped) tail for aquatic environments OR wide/narrow support base for bottle filtration on dry land
> *  **C**onnector - the central threaded ring to connect the base to the adapter
>
> *  Optional: CARTRIDGE (top and bottom) for easy loading of filter membranes
